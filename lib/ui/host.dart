...
class _HostState extends State<Host> {
  ...
  // map controller
  static GoogleMapController mapController=0 as GoogleMapController;
  ...
  late StreamSubscription<QuerySnapshot> subscribe;
  ...
  void updateMarker(LocationData locData, Uint8List imageData) {
    LatLng location = LatLng(locData.latitude??0, locData.longitude??0);
    setState(() {
  ...
  RaisedButton({required Future<Null> Function() onPressed, required Text child, required MaterialColor color}) {}
}
